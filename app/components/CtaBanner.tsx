...
const WHATSAPP =
    "https://wa.me/2348133227930?text=Hi! I want to place an order at Best Deal Supermarket 🛒";
        ...
        <section className="relative bg-gradient-to-br from-green to-[#0f3d20] py-20 px-8 text-center overflow-hidden">
            ...
            >
                ...
                <p className="text-white/75 text-base leading-relaxed mb-8">
                    Message us on WhatsApp, tell us what you need, and
                    we&apos;ll sort you out. Fast, easy, and delivered to your
                    door.
                </p>
                <a
                    href={WHATSAPP}
                ...
                >
                    <ShoppingBasket size={40} className="text-cream" />

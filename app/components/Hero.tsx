...
const WHATSAPP_ORDER = "https://wa.me/2348133227930?text=Hi! I want to place an order 🛒";

const stats = [
  { icon: "🛍️", number: "500+", label: "Products In Stock" },
  { icon: "🚀", number: "Fast", label: "Same Day Delivery" },
  { icon: "💰", number: "Best", label: "Prices Guaranteed" },
  { icon: "⭐", number: "4.9★", label: "Customer Rating" },
  { icon: "📦", number: "Daily", label: "Fresh Stock" },
  { icon: "✅", number: "100%", label: "Quality Assured" },
];
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center relative z-10 w-full">
        ...
        >
          ...
          <h1 className="font-playfair text-5xl md:text-6xl font-black text-white leading-tight mb-6">
            Shop Smart.<br />
            Live <em className="not-italic text-gold-light">Better.</em>
          </h1>

          <p className="text-white/65 text-lg leading-relaxed mb-10 max-w-md">
            Asaba&apos;s most trusted supermarket. From fresh groceries to household
            essentials — we stock everything you need at the best prices around.
          </p>
        ...
        >
          {stats.map((stat, i) => (
            ...
            >
              ...
              <div className="font-playfair text-2xl font-black text-gold-light">{stat.number}</div>

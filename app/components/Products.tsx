...
const WHATSAPP_ALL =
    "https://wa.me/2348133227930?text=Hi! Please send me your full product list 📋";
                ...
                <div className="flex justify-between items-end flex-wrap gap-4 mb-12">
                    ...
                    >
                        ...
                        <p className="text-white/50 text-base max-w-md leading-relaxed">
                            Tap any item to order directly on WhatsApp — fast
                            and easy.
                        </p>
                    </motion.div>
                    <a
                    ...
                    {products.map((product, i) => (
                        ...
                        >
                            ...
                            <div className="p-5">
                                ...
                                <div className="text-xs text-white/45 mb-4 leading-relaxed">
                                    {product.desc}
                                </div>
